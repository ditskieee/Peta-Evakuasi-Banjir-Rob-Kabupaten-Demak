...
var format_TtitikEvakuasi_31 = new ol.format.GeoJSON();
var features_TtitikEvakuasi_31 = format_TtitikEvakuasi_31.readFeatures(json_TtitikEvakuasi_31, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TtitikEvakuasi_31 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TtitikEvakuasi_31.addFeatures(features_TtitikEvakuasi_31);
var lyr_TtitikEvakuasi_31 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_TtitikEvakuasi_31, 
                style: style_TtitikEvakuasi_31,
                popuplayertitle: 'Ttitik Evakuasi',
                interactive: true,
                title: '<img src="styles/legend/TtitikEvakuasi_31.png" /> Ttitik Evakuasi'
            });
var format_BatasWilayahiKabDemak_32 = new ol.format.GeoJSON();
var features_BatasWilayahiKabDemak_32 = format_BatasWilayahiKabDemak_32.readFeatures(json_BatasWilayahiKabDemak_32, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_BatasWilayahiKabDemak_32 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_BatasWilayahiKabDemak_32.addFeatures(features_BatasWilayahiKabDemak_32);
var lyr_BatasWilayahiKabDemak_32 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_BatasWilayahiKabDemak_32, 
                style: style_BatasWilayahiKabDemak_32,
                popuplayertitle: 'Batas Wilayahi Kab. Demak',
                interactive: false,
                title: '<img src="styles/legend/BatasWilayahiKabDemak_32.png" /> Batas Wilayahi Kab. Demak'
            });
var group_FastestRoute = new ol.layer.Group({
...
lyr_TtitikEvakuasi_31.set('fieldImages', {'id': 'TextEdit', 'DUKUH/DESA': 'TextEdit', 'Foto Evac': 'ExternalResource', });
lyr_BatasWilayahiKabDemak_32.set('fieldImages', {'KARKTR': 'TextEdit', 'STSBTS': 'TextEdit', 'FCODE': 'TextEdit', 'KELAS': 'TextEdit', 'UUPP': 'TextEdit', 'LOKASI': 'TextEdit', 'REMARK': 'TextEdit', 'NAMOBJ': 'TextEdit', 'ADMIN1': 'TextEdit', 'ADMIN2': 'TextEdit', 'SRS_ID': 'TextEdit', 'LCODE': 'TextEdit', 'METADATA': 'TextEdit', 'WAKLD1': 'TextEdit', 'WAKLD2': 'TextEdit', 'WADKC1': 'TextEdit', 'WADKC2': 'TextEdit', 'WAKBK1': 'TextEdit', 'WAKBK2': 'TextEdit', 'WAPRO1': 'TextEdit', 'WAPRO2': 'TextEdit', 'TIPTBT': 'TextEdit', 'PJGBTS': 'TextEdit', 'KLBADM': 'TextEdit', 'TIPLOK': 'TextEdit', 'SHAPE_Leng': 'TextEdit', });
...
lyr_TtitikEvakuasi_31.set('fieldLabels', {'id': 'no label', 'DUKUH/DESA': 'no label', 'Foto Evac': 'no label', });
lyr_BatasWilayahiKabDemak_32.set('fieldLabels', {'KARKTR': 'no label', 'STSBTS': 'no label', 'FCODE': 'no label', 'KELAS': 'no label', 'UUPP': 'no label', 'LOKASI': 'no label', 'REMARK': 'no label', 'NAMOBJ': 'no label', 'ADMIN1': 'no label', 'ADMIN2': 'no label', 'SRS_ID': 'no label', 'LCODE': 'no label', 'METADATA': 'no label', 'WAKLD1': 'no label', 'WAKLD2': 'no label', 'WADKC1': 'no label', 'WADKC2': 'no label', 'WAKBK1': 'no label', 'WAKBK2': 'no label', 'WAPRO1': 'no label', 'WAPRO2': 'no label', 'TIPTBT': 'no label', 'PJGBTS': 'no label', 'KLBADM': 'no label', 'TIPLOK': 'no label', 'SHAPE_Leng': 'no label', });
lyr_BatasWilayahiKabDemak_32.on('precompose', function(evt) {
